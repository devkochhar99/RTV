...
public class AdminForgotPassword extends Activity 
{
				...
				try
				{
					...
					else
					{
						if(uniquecode1.equals(uniquecode))
						{
					        ...
					        {
								Toast.makeText(getApplicationContext(),"Sorry! You are not registered with us as Admin",Toast.LENGTH_LONG).show();
					        }
